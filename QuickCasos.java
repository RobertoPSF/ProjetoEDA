public class QuickCasos extends Escrever{
    public static void quickSortCasos(Dados[] vetor) {
        ...
        System.out.println("\nQuickSort para quantidade de casos acumulados para caso médio: " + (totalTime) + " milisegundos");
    ...
    public static void quickSortCasosMelhor(Dados[] vetor) {
        ...
        long totalTime = System.nanoTime() - startTime;
        System.out.println("\nQuickSort para quantidade de casos acumulados para o melhor caso: " + (totalTime) + " milisegundos");
        double memoriaUtilizada = ( (double)((double)(Runtime.getRuntime().totalMemory()/1024)/1024))- ((double)((double)(Runtime.getRuntime().freeMemory()/1024)/1024));
        System.out.printf("Memória utlizada: %.2f Mb\n", memoriaUtilizada);
        System.out.printf("Memória utlizada: %.3f Gb\n", memoriaUtilizada/1024);
    ...
    public static void quickSortCasosPior(Dados[] vetor) {
        ...
        long totalTime = System.nanoTime() - startTime;
        System.out.println("\nQuickSort para quantidade de casos acumulados para o pior caso: " + (totalTime) + " milisegundos");
        double memoriaUtilizada = ( (double)((double)(Runtime.getRuntime().totalMemory()/1024)/1024))- ((double)((double)(Runtime.getRuntime().freeMemory()/1024)/1024));
        System.out.printf("Memória utlizada: %.2f Mb\n", memoriaUtilizada);
        System.out.printf("Memória utlizada: %.3f Gb\n", memoriaUtilizada/1024);
